...
def find_nearest(data, target, align='front', max_time_diff=None):
    ...
    Args:
      ...
      * align (str): `front` or `back`.  Align with the front of the event
